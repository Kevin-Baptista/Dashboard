...
--
-- Host: localhost:3307
-- Tempo de geração: 21-Jan-2022 às 15:40
...
CREATE TABLE `equipamentos` (
  `codigo do equipamento` int(4) DEFAULT NULL,
  `Nome do Produto` varchar(22) DEFAULT NULL,
  `Agências` varchar(25) DEFAULT NULL,
  `estado do equipamento` varchar(11) DEFAULT NULL
...
INSERT INTO `equipamentos` (`codigo do equipamento`, `Nome do Produto`, `Agências`, `estado do equipamento`) VALUES
(1001, 'Cofre', 'Achada S. Filipe', 'funcionando'),
...
CREATE TABLE `requisicoes` (
  ...
  `Data da requisição` varchar(10) DEFAULT NULL,
  `Tipo de Manutenção` varchar(10) DEFAULT NULL,
  `Data da conclusão` varchar(10) DEFAULT NULL,
  `status` varchar(9) DEFAULT NULL,
  `codigo do equipamento` int(4) DEFAULT NULL,
  `custo de reparação` varchar(13) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `requisicoes` (`codigo`, `Data da requisição`, `Tipo de Manutenção`, `Data da conclusão`, `status`, `codigo do equipamento`, `custo de reparação`) VALUES
(1, '01/10/2021', 'Preventiva', '02/10/2021', 'concluido', 1004, '10 000,00 CVE'),
